        ...
        <ScrollView style={styles.container}>
            ...
            <ImageBackground source={require('../../../assets/vector_1.png')} style={styles.vector}>
                ...
                <View style={{ width: wp(100), paddingHorizontal: '5%' }}>
                    <Text style={{ fontFamily: 'Nunito-Bold', fontSize: hp(2.4), color: '#14BA9C' }}>What would you like to upload today?</Text>
                </View>
                <View style={{ paddingHorizontal: '5%' }}>
                    <Text style={styles.label}>Title</Text>
                    <View style={{ backgroundColor: '#fff', width: '100%', height: hp(7), alignSelf: 'center', borderRadius: 8, marginVertical: '2%', paddingHorizontal: '5%', justifyContent: 'center', borderWidth: 0.4, borderColor: '#524B6B' }}>
                        <TextInput
