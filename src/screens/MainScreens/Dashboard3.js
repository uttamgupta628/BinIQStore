...
const Dashboard3 = () => {
  ...
  const verifyBtnLabel = isVerified && !isExpired
    ? isExpiringSoon ? '⚡ Renew Early' : null   // null = hide button if active
      ...
      <View style={styles.cardsContainer}>
        ...
        <View style={styles.smallCard}>
          ...
          <View style={styles.circleWrapper}>
            <Circle
              size={hp(10)} progress={loading ? 0 : uploadProgress}
              showsText={false} thickness={5}
              color="#00B813" unfilledColor="#DDF4DF"
            />
            <View style={styles.circleTextOverlay}>
              <Text style={styles.circleNumber}>{loading ? '…' : totalUploads}</Text>
...
const styles = StyleSheet.create({
  ...
  smallCard: {
    ...
    alignItems: 'center', width: '48%', height: hp(20), paddingTop: '4%',
  },
  smallCard2: {
    backgroundColor: '#F2F5F8', borderRadius: 6,
    shadowColor: '#000', shadowOffset: {width: 0, height: 2},
    shadowOpacity: 0.1, shadowRadius: 4, elevation: 2,
    alignItems: 'center', width: '48%', height: hp(20), justifyContent: 'center',
  },
  ...
  // Promo stats
  promoStatsRow:    {flexDirection: 'row', alignItems: 'center', marginVertical: hp(1)},
